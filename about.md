...
*[Your Debut Novel Name]* is my latest release. If you want to stay up to date, [join the mailing list here](#).

<div class="contact-links">
  <a href="mailto:{{ site.author.email }}" class="btn btn-ghost">Contact</a>
  <a href="{{ site.author.newsletter_url }}" class="btn btn-ghost" target="_blank">Newsletter</a>
</div>